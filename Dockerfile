...
ENV ROUTER_PROFILE=accuracy_gate \
    ...
    ROUTER_MODELS_REMOTE_ACCURACY=gemma-4-31b-it,kimi-k2p7-code,gemma-4-26b-a4b-it,minimax-m3,gemma-4-31b-it-nvfp4 \
    ROUTER_MODELS_REMOTE_CODE=gemma-4-31b-it,kimi-k2p7-code,gemma-4-26b-a4b-it,minimax-m3,gemma-4-31b-it-nvfp4 \
    ROUTER_MODELS_REMOTE_FORMAT_STRICT=gemma-4-31b-it,kimi-k2p7-code,gemma-4-26b-a4b-it,minimax-m3,gemma-4-31b-it-nvfp4 \
    ROUTER_MODELS_REMOTE_CONCISE=gemma-4-31b-it,kimi-k2p7-code,gemma-4-26b-a4b-it,minimax-m3,gemma-4-31b-it-nvfp4 \
    ROUTER_MODELS_REMOTE_ESCALATION=gemma-4-31b-it,kimi-k2p7-code,gemma-4-26b-a4b-it,minimax-m3,gemma-4-31b-it-nvfp4 \
